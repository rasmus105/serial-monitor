...
fn render_commands(area: Rect, buf: &mut Buffer, scroll: usize) {
    let mut lines: Vec<Line> = vec![
        ...
        Line::from(vec![
            ...
            Span::styled("Up/Down", Theme::keybind()),
            Span::raw(" or "),
            Span::styled("Ctrl+j/k", Theme::keybind()),
            Span::raw(" for suggestions."),
        ]),
        Line::from(vec![
            Span::raw("Press "),
            Span::styled("Enter", Theme::keybind()),
            Span::raw(" to execute, "),
            Span::styled("Ctrl+g", Theme::keybind()),
            Span::raw(" to select a suggestion, "),
